  ...
  return (
    <div className="fixed top-0 left-0 h-screen w-64 bg-gray-800 text-white flex flex-col">
      ...
      <nav className="flex flex-col p-4 space-y-2">
        <a onClick={() => navigate('/')} className="hover:bg-gray-700 rounded p-2">Dashboard</a>
        ...
        <a onClick={logout} className="hover:bg-gray-700 rounded p-2 cursor-pointer">Logout</a>
      </nav>
    </div>
  );
}
